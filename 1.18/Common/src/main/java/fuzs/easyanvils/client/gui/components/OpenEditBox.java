    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        if (this.isVisible()) {
            ...
            if (!string.isEmpty()) {
                ...
                n = this.font.drawShadow(poseStack, this.formatter.apply(string2, this.displayPos), l, m, i);
            }
            ...
            if (!string.isEmpty() && bl && j < string.length()) {
                this.font.drawShadow(poseStack, this.formatter.apply(string.substring(j), this.cursorPos), n, m, i);
            }

            if (!bl3 && this.suggestion != null) {
                this.font.drawShadow(poseStack, this.suggestion, (o - 1), m, -8355712);
            }

            if (bl2 && k == j) {
                if (!string.isEmpty()) {
                    fill(poseStack, o, m - 1, o + 1, m + 1 + 9, -3092272);
                } else {
                    this.font.drawShadow(poseStack, "_", o, m, i);
                }
            }
